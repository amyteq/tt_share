...
class _Rewriter(ast.NodeTransformer):
    def visit_FunctionDef(self, node: ast.FunctionDef):
        ...
        if _has_uncacheable_params(node):
            return node
        ...
        try:
            ...
            for turn_i in range(self.cfg.turns):
                ...
                if self.cfg.debug and self.cfg.debug_req:
                    ...
                    formatted_req = _format_markdown(full_request_text if turn_i % 20 == 0 else snippet)
                ...
                if last_message.recipient == 'python':
                    ...
                    tool_responses = local_tool.process_sync_plus(raw_script, last_message.channel)
