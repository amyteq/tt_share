        ...
        if self.cfg.attempts_mode == "serial":
            ...
            for attempt_index in range(self.cfg.attempts):
                ...
                result = self._process_attempt(
                    ...
                    serial_summary="",      # IMPORTANT: solver doesn't eat summary anymore
...
Processed 26 files (65.28 GB) in 69.47 seconds.

Waiting for vLLM server...
Server is ready (took 133.30 seconds).
...
Budget: 900.00 seconds | Deadline: 1768592515.41
...
|-----|---------|-----------------|--------------|---------------|---------|--------|------|
| 0   | 1       | 17000           | 11           | 2             | 0.744   | 114    | 1:45 |
| 1   | 2       | 16650           | 13           | 1             | 0.733   | 160    | 1:29 |
| 2   | 3       | 23090           | 33           | 4             | 0.679   | 160    | 2:16 |
| 3   | 4       | 12969           | 11           | 1             | 0.764   | 133    | 1:16 |
| 4   | 5       | 15838           | 9            | 2             | 0.728   | 44     | 1:24 |
| 5   | 6       | 17848           | 17           | 1             | 0.717   | 160    | 1:36 |
| 6   | 7       | 20405           | 22           | 2             | 0.715   | 160    | 1:51 |
...
Budget: 900.00 seconds | Deadline: 1768593220.46
...
|     | Attempt | Response Length | Python Calls | Python Errors | Entropy | Answer | Time |
|-----|---------|-----------------|--------------|---------------|---------|--------|------|
| 0   | 1       | 39126           | 76           | 11            | 0.674   | \<NA\> | 4:40 |
| 1   | 2       | 47197           | 49           | 9             | 0.650   | 41754  | 5:22 |
| 2   | 3       | 32181           | 22           | 1             | 0.719   | 23     | 3:04 |
| 3   | 4       | 20607           | 8            | 1             | 0.749   | \<NA\> | 1:53 |
...
Budget: 900.00 seconds | Deadline: 1768594123.38
...
|     | Attempt | Response Length | Python Calls | Python Errors | Entropy | Answer | Time |
|-----|---------|-----------------|--------------|---------------|---------|--------|------|
| 0   | 1       | 8948            | 7            | 1             | 0.751   | 21818  | 0:47 |
| 1   | 2       | 15359           | 7            | 1             | 0.784   | 21818  | 1:21 |
| 2   | 3       | 9614            | 7            | 0             | 0.864   | 21818  | 0:51 |
| 3   | 4       | 16427           | 13           | 0             | 0.795   | 21818  | 1:28 |
